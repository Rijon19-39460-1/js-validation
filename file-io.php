...
//String Validation  
    ...
    if (strlen($_POST["dob"])>15) 
    {  
        $dobErr = " Max character 15";
        $flag = True;  
    }  

    if (strlen($_POST["religion"])>15) 
    {  
...
<fieldset>
    ...
    <span id="fnameErr" style="colour: red;"></span>
    ...
    <span id="lnameErr" style="colour: red;"></span>
    ...
    <span id="religionErr" style="colour: red;"></span>
  ...
  <fieldset>
    ...
    <span id="emailErr" style="colour: red;"></span>
    ...
    <span id="usernameErr" style="colour: red;"></span>
    ...
    <span id="passwordErr" style="colour: red;"></span>
